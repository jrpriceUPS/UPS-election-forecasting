...
Additionally, `r pollsterOfChoice` correctly predicted `r mean(mydata$rightcall)*100`% of races in their last poll for every election polled from `r earlyYear` to `r lateYear`.
...
nocite: |
  @538rawpolldata
  @MaristAcademy
  @2020PrimaryUndecided
  @marginOfError
  @ToyElectionSimulation
  @MRPModelSubgroups
  @DoubleHaters
  @ReadPollsBetter
  @GoodOnlinePolls
  @UpdatePollster2020
  @StatePollsGettingBetter
  @StrategicVisionFraud
  @StrategicVisionAAPOR
---
