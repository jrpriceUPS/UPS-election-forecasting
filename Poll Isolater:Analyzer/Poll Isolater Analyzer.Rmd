...
pollsterOfChoice="Emerson College"
...
Additionally, `r if(evaluatePredictive){"using just the most recent poll from each election predicted more races correctly than using all polls."}` `r if(evaluatePredictive==FALSE){"using just all the polls from ever election predicted more races correctly than using just the most recent poll from each election."}`
