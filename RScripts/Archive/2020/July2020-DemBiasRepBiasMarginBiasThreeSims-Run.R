...
# runs them as three separate simulations instead of together (so takes a long time to run!)
# but definitely the beginning of some fun stuff!
...
source("RScripts/Archive/2020/July2020-DemBiasRepBiasMarginBiasThreeSims.R")
...
source("RScripts/Archive/2020/JAGS-PollsterYear.R")
