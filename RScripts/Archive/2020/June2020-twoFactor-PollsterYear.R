# JAGS script that runs a standard two-factor ANOVA
# to predict margin / dem bias using year and pollster including interactions
# uses standard code from Doing Bayesian Data Analysis, 2nd Ed, Kruschke
#
# Runs! I think the bottom also has the first example of the re-naming of pollsters
#
...
source("RScripts/Archive/DBDA2E-Code/Jags-Ymet-Xnom2fac-MnormalHom.R")
#------------------------------------------------------------------------------- 
