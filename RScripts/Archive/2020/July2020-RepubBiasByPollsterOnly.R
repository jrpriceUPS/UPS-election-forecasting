# adaptation of standard ANOVA code from DBDA2E by Kruschke
# Predicts Republican bias using only pollster
# runs into error when trying to make plots (some pollster with no polls maybe?)
...
source("RScripts/Archive/DBDA2E-Code/Jags-Ymet-Xnom1fac-MnormalHom.R")
