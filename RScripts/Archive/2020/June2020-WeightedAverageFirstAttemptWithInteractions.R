# First pass at poll weighting code. Includes ANCOVA-like interactions
# between sample size and other variables.
# Adapted from Kruschke's text.
# Compiles but MCMC doesn't run.
