...
We can start this exploration by looking into bias modeled as response variable to year, categorized by pollster. It should be noted that this data excludes polls from special elections.
